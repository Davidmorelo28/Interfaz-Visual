        ...
        {screen === "splash" && (
          <div className="fixed inset-0 bg-white flex items-center justify-center z-[9999]">
            <div className="animate-fade-in flex flex-col items-center px-8 sm:px-16 text-center">
              <img src={newLogoPath} alt="Logo Hidro Sinú" className="mb-6 w-32 h-32 sm:w-48 sm:h-48 lg:w-56 lg:h-56 object-contain rounded-2xl" />
        ...
        {screen === "inicio" && (
          <div className="animate-slide-up bg-white rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10">
            <div className="flex flex-col items-center mb-6 sm:mb-8">
              <img src={newLogoPath} alt="Hidro Sinú Logo" className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 object-contain rounded-2xl mb-3" />
